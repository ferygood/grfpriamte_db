...
def load_csv_into_mysql(csv_file_path, db_config):
    try:
        ...
        print("CSV data loaded into primateGRFs table successfully.")
...
if __name__ == "__main__":
    ...
    csv_file_path_local = './raw_data/primateGRFs.csv'
    csv_file_path_container = 'mysql-container:/var/lib/mysql-files/primateGRFs.csv'

    copy_csv_to_container(csv_file_path_local, csv_file_path_container)

    # Load CSV data into MySQL
    load_csv_into_mysql('/var/lib/mysql-files/primateGRFs.csv', db_config)
